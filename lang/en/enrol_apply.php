...
$string['queuesearch_help'] = 'Narrows the queue to applications whose applicant, submitted details or comment contain what you type. Accents are ignored on MySQL and MariaDB, and on PostgreSQL sites whose database allows the unaccent extension to be installed; elsewhere an accented letter has to be typed as it was entered.';
