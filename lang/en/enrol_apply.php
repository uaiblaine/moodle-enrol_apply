...
$string['bulkunchanged'] = 'Applications left unchanged: {$a}';
$string['bulkwait'] = 'Defer enrolment applications';
$string['bulkwaitdesc'] = 'The applications listed below will be moved to the waiting list. Anybody in the selection who is not waiting for a decision is left alone.';
...
$string['confirmusers_desc'] = 'Applications marked with a grey bar are on the waiting list.';
...
$string['enrolmentwaiting'] = 'On the waiting list';
...
$string['outcomewaiting'] = 'On the waiting list';
