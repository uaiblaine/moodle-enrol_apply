...
$string['limitnegative'] = 'This limit cannot be negative. Enter 0 for no limit.';
...
$string['queuefilteranycategory'] = 'Any category';
$string['queuefilteranycourse'] = 'Any course';
$string['queuefiltercategory'] = 'Course category';
$string['queuefiltercount'] = '{$a->matched} of {$a->total} applications';
$string['queuefiltercourse'] = 'Course';
